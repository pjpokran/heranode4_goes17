...
#filename1="/dev/shm/wvh_"+ctime_file_string+"_namer.jpg"
...
# NAMER
file_list = glob.glob('/whirlwind/goes17/wvh/namer/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 (36) images
thefile = open('/whirlwind/goes17/wvh/namer_24_temp.list', 'w')
...
thefile.close
os.rename('/whirlwind/goes17/wvh/namer_24_temp.list','/whirlwind/goes17/wvh/goes17_namer_loop.list')

# 12h // 60 (72)images
thefile = open('/whirlwind/goes17/wvh/namer_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvh/namer_60_temp.list','/whirlwind/goes17/wvh/goes17_namer_loop_60.list')
...
text.set_path_effects(outline_effect)
#
filename1="/whirlwind/goes17/wvhbw/namer/"+ctime_file_string+"_namer.jpg"
#filename1="/dev/shm/wvhbw_"+ctime_file_string+"_namer.jpg"
fig.figimage(aoslogo,  0, fig.bbox.ymax*0.77 - aoslogoheight    , zorder=10)
fig.savefig(filename1, bbox_inches='tight', pad_inches=0)
shutil.copy(filename1, "/whirlwind/goes17/wvhbw/namer/latest_namer_1.jpg")
plt.close(fig)

# NAMER
file_list = glob.glob('/whirlwind/goes17/wvhbw/namer/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 (36) images
thefile = open('/whirlwind/goes17/wvhbw/namer_24_temp.list', 'w')
thelist = file_list[-36:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvhbw/namer_24_temp.list','/whirlwind/goes17/wvhbw/goes17_namer_loop.list')

# 12h // 60 (72)images
thefile = open('/whirlwind/goes17/wvhbw/namer_60_temp.list', 'w')
thelist = file_list[-72:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvhbw/namer_60_temp.list','/whirlwind/goes17/wvhbw/goes17_namer_loop_60.list')
...
#filename2="/dev/shm/wvh_"+ctime_file_string+"_fulldisk.jpg"
...
# FULLDISK Color
file_list = glob.glob('/whirlwind/goes17/wvh/fulldisk/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 (36) images
thefile = open('/whirlwind/goes17/wvh/fulldisk_24_temp.list', 'w')
thelist = file_list[-36:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvh/fulldisk_24_temp.list','/whirlwind/goes17/wvh/goes17_fulldisk_loop.list')

# 12h // 60 (72)images
thefile = open('/whirlwind/goes17/wvh/fulldisk_60_temp.list', 'w')
thelist = file_list[-72:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvh/fulldisk_60_temp.list','/whirlwind/goes17/wvh/goes17_fulldisk_loop_60.list')
...
filename2="/whirlwind/goes17/wvhbw/fulldisk/"+ctime_file_string+"_fulldisk.jpg"
#filename2="/dev/shm/wvhbw_"+ctime_file_string+"_fulldisk.jpg"
fig2.figimage(aoslogo,  0, fig2.bbox.ymax*0.77 - aoslogoheight  , zorder=10)
fig2.savefig(filename2, bbox_inches='tight', pad_inches=0)
shutil.copy(filename2, "/whirlwind/goes17/wvhbw/fulldisk/latest_fulldisk_1.jpg")
plt.close(fig2)

# FULLDISK B/W
file_list = glob.glob('/whirlwind/goes17/wvhbw/fulldisk/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 (36) images
thefile = open('/whirlwind/goes17/wvhbw/fulldisk_24_temp.list', 'w')
thelist = file_list[-36:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvhbw/fulldisk_24_temp.list','/whirlwind/goes17/wvhbw/goes17_fulldisk_loop.list')

# 12h // 60 (72)images
thefile = open('/whirlwind/goes17/wvhbw/fulldisk_60_temp.list', 'w')
thelist = file_list[-72:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvhbw/fulldisk_60_temp.list','/whirlwind/goes17/wvhbw/goes17_fulldisk_loop_60.list')
...
#filename3="/dev/shm/wvh_"+ctime_file_string+"_npac.jpg"
...
# NPAC Color
file_list = glob.glob('/whirlwind/goes17/wvh/npac/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 (36) images
thefile = open('/whirlwind/goes17/wvh/npac_24_temp.list', 'w')
thelist = file_list[-36:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvh/npac_24_temp.list','/whirlwind/goes17/wvh/goes17_npac_loop.list')

# 12h // 60 (72)images
thefile = open('/whirlwind/goes17/wvh/npac_60_temp.list', 'w')
thelist = file_list[-72:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvh/npac_60_temp.list','/whirlwind/goes17/wvh/goes17_npac_loop_60.list')
...
text3.set_path_effects(outline_effect)
#
filename3="/whirlwind/goes17/wvhbw/npac/"+ctime_file_string+"_npac.jpg"
#filename3="/dev/shm/wvhbw_"+ctime_file_string+"_npac.jpg"
fig3.figimage(aoslogo,  0, fig3.bbox.ymax*0.77 - aoslogoheight  , zorder=10)
fig3.savefig(filename3, bbox_inches='tight', pad_inches=0)
shutil.copy(filename3, "/whirlwind/goes17/wvhbw/npac/latest_npac_1.jpg")
plt.close(fig3)

# NPAC B/W
file_list = glob.glob('/whirlwind/goes17/wvhbw/npac/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 (36) images
thefile = open('/whirlwind/goes17/wvhbw/npac_24_temp.list', 'w')
thelist = file_list[-36:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvhbw/npac_24_temp.list','/whirlwind/goes17/wvhbw/goes17_npac_loop.list')

# 12h // 60 (72)images
thefile = open('/whirlwind/goes17/wvhbw/npac_60_temp.list', 'w')
thelist = file_list[-72:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvhbw/npac_60_temp.list','/whirlwind/goes17/wvhbw/goes17_npac_loop_60.list')
...
#filename4="/dev/shm/wvh_"+ctime_file_string+"_ak.jpg"
...
# AK Color
file_list = glob.glob('/whirlwind/goes17/wvh/ak/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 (36) images
thefile = open('/whirlwind/goes17/wvh/ak_24_temp.list', 'w')
thelist = file_list[-36:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvh/ak_24_temp.list','/whirlwind/goes17/wvh/goes17_ak_loop.list')

# 12h // 60 (72)images
thefile = open('/whirlwind/goes17/wvh/ak_60_temp.list', 'w')
thelist = file_list[-72:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvh/ak_60_temp.list','/whirlwind/goes17/wvh/goes17_ak_loop_60.list')
...
text4.set_path_effects(outline_effect)
#
filename4="/whirlwind/goes17/wvhbw/ak/"+ctime_file_string+"_ak.jpg"
#filename4="/dev/shm/wvhbw_"+ctime_file_string+"_ak.jpg"
fig4.figimage(aoslogo,  0, fig4.bbox.ymax*0.77 - aoslogoheight  , zorder=10)
fig4.savefig(filename4, bbox_inches='tight', pad_inches=0)
shutil.copy(filename4, "/whirlwind/goes17/wvhbw/ak/latest_ak_1.jpg")

plt.close(fig4)

# AK B/W
file_list = glob.glob('/whirlwind/goes17/wvhbw/ak/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 (36) images
thefile = open('/whirlwind/goes17/wvhbw/ak_24_temp.list', 'w')
thelist = file_list[-36:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvhbw/ak_24_temp.list','/whirlwind/goes17/wvhbw/goes17_ak_loop.list')

# 12h // 60 (72)images
thefile = open('/whirlwind/goes17/wvhbw/ak_60_temp.list', 'w')
thelist = file_list[-72:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/wvhbw/ak_60_temp.list','/whirlwind/goes17/wvhbw/goes17_ak_loop_60.list')
...
#filename9="/dev/shm/wvh_"+ctime_file_string+"_fulldisk_full.jpg"
...
fig9.figimage(aoslogo,  0, fig9.bbox.ymax*0.77 - aoslogoheight  , zorder=10)
fig9.savefig(filename9, bbox_inches='tight', pad_inches=0)
shutil.copy(filename9, "/whirlwind/goes17/wvhbw/fulldisk_full/latest_fulldisk_full_1.jpg")
plt.close(fig9)
